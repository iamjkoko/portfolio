...
function Experiments() {
  ...
  return (
    ...
    <section id="experiments" className="w-full min-h-screen flex flex-col items-center pt-32 pb-[60px] max-[935px]:pt-20 max-[935px]:pb-[5px]">
        ...
        <div className="border-2 border-[#212121] overflow-hidden">
            <a href="https://www.instagram.com/reel/DPv1cFeCTpc/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer">    
        ...
        <div className="border-2 border-[#212121] overflow-hidden">
            <a href="https://www.instagram.com/p/DNk22rezAn5/?utm_source=ig_web_button_share_sheet&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer">
            <div className="max-w-[810px] max-h-[540px] w-full aspect-[3/2] overflow-hidden max-[935px]:max-w-[750px] max-[935px]:max-h-[500px] max-[935px]:h-auto">
        ...
        <div className="border-2 border-[#212121] overflow-hidden">
            <a href="https://www.instagram.com/p/DK91prIv5fk/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" target="_blank" rel="noopener noreferrer">
            <div className="max-w-[810px] max-h-[540px] w-full aspect-[3/2] overflow-hidden max-[935px]:max-w-[750px] max-[935px]:max-h-[500px] max-[935px]:h-auto">
